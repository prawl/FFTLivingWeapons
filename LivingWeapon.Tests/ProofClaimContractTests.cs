...
public class ProofClaimContractTests
{
    ...
    private static readonly Dictionary<string, int> Baseline = new(StringComparer.Ordinal)
    {
        ...
        { "LivingWeapon/AttackRow.Policy.cs", 3 },
        { "LivingWeapon/AttackRow.cs", 1 },
        { "LivingWeapon/Band.cs", 4 },
        { "LivingWeapon/Barrage.Policy.cs", 4 },
        { "LivingWeapon/Barrage.cs", 1 },
        { "LivingWeapon/BattleCensus.cs", 1 },
        { "LivingWeapon/BattleState.cs", 1 },
        ...
        { "LivingWeapon/StatusApply.cs", 1 },
        { "LivingWeapon/Tuning.cs", 7 },
        ...
        { "LivingWeapon.Tests/BarrageTests.cs", 12 },
        { "LivingWeapon.Tests/BattleStateTests.cs", 2 },
        ...
        { "LivingWeapon.Tests/FeignDeathTests.cs", 1 },

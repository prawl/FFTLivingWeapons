...
- **Recolored menu icons and rewritten descriptions for the full roster**, plus fresh names for all but the iconic legendaries and samurai katanas. Every item ships an `ei_<id>` / `ei_s_<id>` icon pair (472 `.tex` files total, the brand-new weapons past the game's own 261-item wall included).

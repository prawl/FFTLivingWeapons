2.0 Release TODO's
- Does spells like Doom count towards a weapon kill count?
- I don't like the Ravager Knight Sword always apply Bereserk
- Does the Sunderer destroy multiple pieces of gear?
- Should Time Mage's Metor have such a huge range?
- Make sure the DLC items are back in place
- Determine which weapons need the shop treatment, poaching treatment, etc
- Re add reraise to Dragon Rod
- Does the wellspring rod actually absorb MP?
- Thorough sweep of other mods
- Make the Genji Gloves Red like the rest of the set
- Dual Wielding a Magick Rod and a Knife does two magick attacks?
